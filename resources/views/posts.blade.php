...
@section('container')
        ...
        <div class="col-md-6">
            <form action="/posts">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Search.." name="search" name="search"
    ...
    @else
        <h1 class="container mt-5 p-5 text-center fs-1 fw-bold text-danger">No Post Found !!!</h1>
    @endif
